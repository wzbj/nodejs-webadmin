...
//   	console.log($("#opts.activeClass"));
      ...
      return this.each(function () {
        ...
        obj.html('<div class="next" style="float:right">' + opts.next + '</div><ul class="pagingUl">' + str1 + str + '</ul><div class="prv" style="float:right">' + opts.prv + '</div>');
